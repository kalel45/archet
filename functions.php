...
//marker_53.bindPopup("<b>Hello world!</b><br>I am a popup.").openPopup();

//add_action('pre_get_posts', 'getMarkerList'); 
...
function get_content() {
	...
	else
	{
		...
		print "<h4>".$title."</h4>".$content; // ! ceci sera renvoyé au client !
	}
	die(); //important
}
?>
